if (missionNamespace getVariable ['aDebugMessages',false]) then { diag_log '- ar_fn_flares Start -';};

execVM "scripts\ar_fn_flares\ar_fn_detected.sqf";
execVM "scripts\ar_fn_flares\ar_fn_closestMortarOpfor.sqf";
execVM "scripts\ar_fn_flares\setupDedection.sqf";
...
if (missionNamespace getVariable ['aDebugMessages',false]) then { diag_log '- ar_fn_flares Setup -';};